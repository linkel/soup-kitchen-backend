...
class InventoryPage extends React.Component {
    ...
    componentDidMount() {
        ...
        .then(response => 
        {
            this.setState({items: response.data.items, expiry: 5})
    ...
    handleCategory = (id) => {
        ...
        if (id === "-1") {
            ...
            .then(response => 
            {
                this.setState({items: response.data.items, selected_category: id, expiry: 5})
                this.tokenExp();
            ...
            .then(response => 
            {
                this.setState({items: response.data.category.items, selected_category: id, expiry: 5})
                this.tokenExp();
            })
            .catch(err => {
                console.log(err);
